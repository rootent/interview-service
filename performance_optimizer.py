"""
Performance Optimizer - Monitor and optimize RAG system performance
"""
...
class PerformanceOptimizer:
    ...
    def print_performance_report(self):
        ...
        if summary['api']['average_response_time'] > 2.0:
            print("   ⚠️  API responses are slow - consider reducing content length")
...
def optimize_config():
    ...
    print("   • MAX_CONTENT_LENGTH: 800 (shorter content)")
    print("   • MAX_FOLLOW_UPS: 1 (fewer follow-ups)")
    
    print("\n⚠️  Note: Smaller values may reduce quality but increase speed")
...
def run_performance_test():
    ...
    if success:
        ...
        if success:
            ...
            total_time = rag_stats['processing_time'] + embedding_time + question_time
            ...
            if total_time < 10:
                ...
                rating = "⚠️  SLOW - Needs optimization"
...
if __name__ == "__main__":
    ...
    while True:
        print("\nChoose an option:")
        print("1. Run Performance Test")
        print("2. Show Optimization Suggestions")
        print("3. Exit")
